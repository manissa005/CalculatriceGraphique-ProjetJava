...
public class ZoomControler extends CalculatriceControler{
	...
	/** on initialise l'axe du zoom a None */
	...
	/**
	 * 	 on definit le filtre de la souris pour pouvoir demarrer le zoom,Si le filtre consomme l'evenement
	 *   alors l'evenement est ignore. Si le filtre est nul, tous les evenements sont traverses.
	 * @param event
	 * @return
	 */
	...
	/**
	 * quand on presse sur le bouton de la souris
	 */
	...
	/**
	 * on ne lance pas le processus de selection tant que l'utilisateur n'a pas effectue un glissement de souris
	 * mais on enregistre quand meme les coordonnees d'ou il a commence et selecting on le met a true
	 */
	...
	private class MouseWheelZoom implements EventHandler<ScrollEvent> {
		...
		public void handle( ScrollEvent event ) {
			...
			if ( eventType == ScrollEvent.SCROLL_STARTED ) {
				...
				/** on retourne  les coordonnees de l'evenement sous forme d'un point par rapport a chart*/
