 ...
 *
 * on utilise des Noeuds car ils ont un systeme d'evenement pour gerer la souris, le clavier...
 */
...
public class ChartCoordonnee {
	...
	/**
	 *  cette methode prend (x,y) en argument et les retourne sous forme d'un point
	 *  on l'utilise pour retourner les coordonnees d'un evenement sur la chart sous forme d'un point
	 * @param x
	 * @param y
	 * @return
	 */
	...
	/**
	 * 	on retourne un rectangle avec les idmensions passees en argument
