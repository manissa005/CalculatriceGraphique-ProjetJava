...
/**
 * C'est la classe qui nous sert comme controleur pour la calculatrice, cest ici qu'on lance le calcul et on stocke les donnees dans des series
 * puis les ajouter a notre chart pour avoir le trace a la fin
 */
public class CalculatriceControler implements Serializable {
	...
	public void dessiner2() throws InputException {
        ...
        while (i <= imax) {
            ...
            if (x <= 50 && x >= -50) { //valeurs fixes pour toutes les fonctions que notre calculatrice va tracer
                bool = false;
